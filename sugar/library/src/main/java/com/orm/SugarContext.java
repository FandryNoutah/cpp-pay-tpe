...
public class SugarContext {
    ...
    private SugarContext(String[] mSecrets) {
        this.sugarDb = SugarDb.getInstance(mSecrets);
    ...
    public static void init(Context context,String[] secrets) {
        ContextUtil.init(context);
        instance = new SugarContext(secrets);
